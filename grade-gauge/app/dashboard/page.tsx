  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:px-6">
      ...
      <section className="mt-6 space-y-4">
        <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Your classes</h2>

        {classes.length === 0 ? (
          <div className="rounded-lg border border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-6 text-sm text-gray-500 dark:text-gray-400">
