  ...
  return (
    <main className="mx-auto max-w-md px-4 py-10 sm:px-6">
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 text-center">
        ...
        <h1 className="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100">{preview.name}</h1>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{preview.subject}</p>
